...
class ThreeLayerConvNet(object):
	...
	hidden_dim=100, num_classes=10, weight_scale=1e-3, reg=0.0, dtype=np.float32):
		...
		#self.params['W2'] = np.random.normal(0, weight_scale, (num_filters, input_dim[1], filter_size, filter_size))
		#self.params['b2'] = np.zeros(input_dim[1])
		
		w_shape = num_filters * input_dim[1] * input_dim[2] / 4
		#print(input_dim, input_dim[2])
	...
	def loss(self, X, y=None):
		...
		############################################################################
		#conv - relu - 2x2 max pool - affine - relu - affine - softmax
		#conv_out, cache_conv = conv_relu_forward(X, W1, b1, conv_param)
		#pool_out, cache_pool = max_pool_forward_fast(conv_out, pool_param)
		#arf_out, cache_arf = affine_relu_forward(pool_out, W2, b2)
		...
		#dx_fast = max_pool_backward_fast(a_x, cache_pool)
		#da_x, a_w, a_b = conv_relu_backward(dx_fast, cache_conv)
